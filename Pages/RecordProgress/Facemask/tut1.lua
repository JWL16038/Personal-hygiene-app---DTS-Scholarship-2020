...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut2",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Clean your hands with soap and water or hand sanitizer before touching the mask.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
