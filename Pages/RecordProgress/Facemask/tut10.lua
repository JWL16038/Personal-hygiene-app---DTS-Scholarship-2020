...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut11",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Face Mask with Ear loops: Hold both of the ear loops and gently lift and remove the mask.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
