...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut7",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Mold or pinch the stiff edge to the shape of your nose.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
