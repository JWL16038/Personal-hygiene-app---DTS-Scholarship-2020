...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut12",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Face Mask with Ties: Untie the bottom bow first then untie the top bow and pull the mask away from you as the ties are loosened.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
