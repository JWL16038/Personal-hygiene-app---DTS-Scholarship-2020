...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut8",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "If using a face mask with ties: Then take the bottom ties, one in each hand, and secure with a bow at the nape of your neck.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
