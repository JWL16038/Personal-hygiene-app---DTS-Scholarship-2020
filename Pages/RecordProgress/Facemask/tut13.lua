...
function scene:show( event )
	...
	local questionText = display.newText( "Throw the mask in the trash. Clean your hands with soap and water or hand sanitizer.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
