...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut4",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Determine which side of the mask is the top. The side of the mask that has a stiff bendable edge is the top and is meant to mold to the shape of your nose.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
