...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut9",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Pull the bottom of the mask over your mouth and chin.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
