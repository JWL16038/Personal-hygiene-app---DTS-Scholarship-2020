...
local function gotoNext(event)
	if event.phase == "ended" then
		composer.gotoScene("Pages.RecordProgress.Facemask.tut13",{effect="slideLeft"})
	end
end
...
function scene:show( event )
	...
	local questionText = display.newText( "Face Mask with Bands: Lift the bottom strap over your head first then pull the top strap over your head.", CentreX, CentreY, ScreenWidth - 25, 0,native.systemFont, 26 )
