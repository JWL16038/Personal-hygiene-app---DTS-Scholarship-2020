...
local function takeAnswer(event)
	if event.phase == "ended" then
		if event.target.id == "Yes" then
			...
			composer.gotoScene("Pages.RecordProgress.Handwashing.agree",{effect="slideLeft"})
		elseif event.target.id == "Maybe" then 
			print("user answered maybe")
			composer.gotoScene("Pages.RecordProgress.Handwashing.disagree",{effect="slideLeft"})
